        ...
        <div className="relative mx-auto max-w-[920px] px-6 pb-16 pt-20 text-center sm:pb-20 sm:pt-24">
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-3">
            <a
              ...
              className="inline-flex items-center gap-2.5 rounded-full px-4 py-2 transition-colors hover:border-[#a3ff12]"
              style={{ background: INK.panel, border: `1px solid ${INK.panelBorder}` }}
            >
              <svg viewBox="0 0 24 24" className="h-3 w-3" fill={INK.white} aria-hidden>
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
              </svg>
              <span className="text-[8px] tracking-widest" style={{ ...pixelFont, color: INK.text }}>
                AN EVAL BY SHAWN ESQUIVEL
              </span>
            </a>
            <a
              href="https://github.com/shawnesquivel/boomer-evals"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2.5 rounded-full px-4 py-2 transition-colors hover:border-[#a3ff12]"
              style={{ background: INK.panel, border: `1px solid ${INK.panelBorder}` }}
            >
              <svg viewBox="0 0 16 16" className="h-3.5 w-3.5" fill={INK.white} aria-hidden>
