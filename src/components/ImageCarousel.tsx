...
const SLIDES = [
  {
    src: "/linkedin-dev.png",
    caption: "Founding Engineer at a $79M Series A company",
  },
  {
    src: "/about-me-app.png",
    caption:
      "Generated over $40K in revenue with my AI agency. Cursor is my only subscription.",
  },
  { src: "/about-me-cursor.png", caption: "Top 1% Cursor user" },
  {
    src: "/about-me-cursor-workshops.png",
    caption: "Hosted a 200+ member Cursor event in Vancouver",
  },
  {
    src: "/about-me-cursor-thailand.png",
    caption: "100+ attendee Cursor event in Thailand",
  },
];
